...
// Function to fetch building data from the server and update the sidebar
async function fetchBuildingData() {
    try {
        const response = await fetch('/api/buildings'); // Send request to the server
