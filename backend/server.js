...
// const { svgIconBlockB } = require('../fetchIcons.js');
// const images = require('./images');

// const {test2} = require("./controllers/test1.js");
// const {icnSend} = require("./routes/getImage.js");
...
//       const base64Icon = Buffer.from(svgIconBlockB).toString('base64');
  
//       // Create a new Icon document
//       const newImage = new icons({ // You can set any name you like
//         image: base64Icon, // Store Base64 encoded SVG string
//       });
  
//       // Save the new image to the database
//       const result = await newImage.save();
//       console.log('SVG uploaded successfully:', result);
//     } catch (e) {
//       console.log('Error uploading SVG:', e.message);
//     }
//   }
